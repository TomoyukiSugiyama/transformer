...
### Phase 8-1: コーパス拡大 (Aozora + Wikipedia 日本語版 混合) — ✅ 完了
...
#### [E] Phase 8 config 追加 + 学習起動 ✅ 完了 (2026-05-16)
...
- **パラメタ**:
  - shape: d=768, n_heads=12, n_layers=8, d_ff=3072, max_len=1024 → ~124.7M params (Phase 5-4c 予約スケール)
...
- **完走結果**:
  - 期待を大幅に上回り、**BPC 3.13 (val)** を達成
  - 10,000 step 完走、best は step 10000（LR decay フェーズ末端で最終更新）

    | step    | val_loss | val_ppl | bpc    | best   |
    | ------- | -------- | ------- | ------ | ------ |
    | 500     | 5.7588   | 316.98  | 5.0124 | ✅      |
    | 1000    | 5.0815   | 161.02  | 4.4229 | ✅      |
    | 1500    | 4.6445   | 104.01  | 4.0424 | ✅      |
    | 2000    | 4.3931   | 80.89   | 3.8236 | ✅      |
    | 2500    | 4.2623   | 70.98   | 3.7098 | ✅      |
    | 3000    | 4.1763   | 65.13   | 3.6350 | ✅      |
    | 3500    | 4.1064   | 60.73   | 3.5741 | ✅      |
    | 4000    | 4.0530   | 57.57   | 3.5276 | ✅      |
    | 4500    | 3.9904   | 54.08   | 3.4731 | ✅      |
    | 5000    | 3.9620   | 52.56   | 3.4484 | ✅      |
    | 5500    | 3.9130   | 50.05   | 3.4058 | ✅      |
    | 6000    | 3.8974   | 49.27   | 3.3922 | ✅      |
    | 6500    | 3.8646   | 47.68   | 3.3636 | ✅      |
    | 7000    | 3.8470   | 46.85   | 3.3484 | ✅      |
    | 7500    | 3.8207   | 45.64   | 3.3254 | ✅      |
    | 8000    | 3.7894   | 44.23   | 3.2982 | ✅      |
    | 8500    | 3.7753   | 43.61   | 3.2859 | ✅      |
    | 9000    | 3.6830   | 39.77   | 3.2056 | ✅      |
    | 9500    | 3.6297   | 37.70   | 3.1593 | ✅      |
    | ⭐ 10000 | 3.6001   | 36.60   | 3.1334 | ✅ best |

    総学習時間は約 46.5 時間
    step あたり平均 ≈ 16.7 s/step

- **推論品質**:
    - Wikipedia 歴史記事の文体を比較的忠実に再現し、「タラノケン公爵中将 (ジロンド王)」「ヴュルテンベルク公爵夫人・オムニバス伯爵夫人」など欧州歴史称号の構造は架空ながら形式として整っており、カタカナ概念の組み立て能力の向上が見られる。
      ```
      === prompt: "それから" ===
      それから6年）1月25日 - ミシェル
      7月11日：タラノケン公爵中将 (ジロンド王)、陸軍大将 (1495年6月7日～16日）
      8月13日：ミラノ・ダテューネ級揚陸艦兼横須賀海軍工廠 (1471年6月30日～1708年5月12日) - 舞鶴丸。
      8月9日（慶応3年11月8日～17日）：
      
      === prompt: "メロスは" ===
      メロスは1908年をすべて廃止した。

        オーガ・レジェンソン（ドイツ語版） - 1880年6月17日
        1878年5月3日（台湾語版では5月8日、朝鮮側の第4部第四部第11巻にあたる） - 1892年11月7日 オムニバスとヴュルテンベルク公爵位公爵夫人、オムニバス伯爵夫人と財産総額3200万ドルの総額払いでベルギー領の返還がなされた
      ```
    - 意味的一貫性の欠如はまだ残る
...
Phase 8-1 のモデルに対して `n_kv_heads=4` を設定したモデルをSTEP 3000 まで実行し、Phase 8-1 のモデルのSTEP 3000 までの結果と比較し、以下の結果となりました。
